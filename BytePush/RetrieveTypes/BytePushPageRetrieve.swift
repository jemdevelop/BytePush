...
public struct BytePushPageRetrieve: WordPressRetrieve {
    ...
    public func execute(withAuthenticationItem item: URLQueryItem?, result: @escaping (WordPressRetrieveResult<BytePushPage>) -> Void) {
